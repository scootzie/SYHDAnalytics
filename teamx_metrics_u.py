...
def plot_to_folder(folder):
    ...
    ax[0].set_title("'Mark as Contacted' DAU, WAU, and MAU Over Time")
    ...
    # Graph 2 - 'Mark as Contacted' Stickiness (DAU/MAU and WAU/MAU)
    ...
    ax[1].set_title("'Mark as Contacted' Stickiness - DAU and WAU over MAU")
    ...
    # plt.show()
    file_name = '/Mark as Contacted - DAU, WAU, MAU, and Stickiness.pdf'
